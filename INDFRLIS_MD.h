...
//------------------------------------------------------------------------------------
/*
Nombre Clase : 	  INDFRLIS_MD (Estructura de información de relación de flujo diferencial de entradas tipo 'MD').
...
namespace UPC
{
	...
	public:
		...
		vo Set(dou **_in_dif_rg, dou _ev_dif_rg, in _x_length, in _y_length, in _str1_id, in _str2_id, in _upci_id_str1, in _upci_id_str2, in _cs_srg, dou _rs_srg, dou _al_srg, dedein &_rl);
