...
//-------------------------------------------------------------------------------------
//librerias.
#include "UPCI_ARG_VDS.h"

//-------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------
//#1: constructor 1.
UPCI_ARG_VDS::UPCI_ARG_VDS()
{
...
//-------------------------------------------------------------------------------------
//#2: constructor 2.
UPCI_ARG_VDS::UPCI_ARG_VDS(in	_inis_vd_amount_allowed,
						   ...
						   in	_timeout_update_al_is)
{
	...
	this->inis_vd_amount_allowed			= _inis_vd_amount_allowed;								//cantidad de estructuras inis_vd permitidas.
	this->acis_vs_amount_allowed			= _acis_vs_amount_allowed;								//cantidad de estructuras acis_vs permitidas.
	this->rlis_amount_allowed				= _rlis_amount_allowed;									//cantidad de estructuras rlis permitidas.

	//---------------------------------------------------------------------------------
    //inicialización de argumentos: dimensiones del registro de entrada.
	...
	this->indfrlis_vd_strength_threshold	= _indfrlis_vd_strength_threshold;						//umbral de fortaleza de relación INDFRLIS_VD para eliminar relación por N.A.
...
vo  UPCI_ARG_VDS::Initialize(in		_inis_vd_amount_allowed,
							 in		_acis_vs_amount_allowed,
							 in		_rlis_amount_allowed,
							 in     _x_length,
							 dou	_default_activity_level,
...
vo	UPCI_ARG_VDS::SetPtrBuff(in					*_suspended_actions_maximization_flag,
						     ...
						     dededein			*_buff_inprrlis_vd_can)
 {
	...
	this->buff_upci_vds							= _buff_upci_vds;
	...
	this->buff_inis_vd_activated				= _buff_inis_vd_activated;
	this->buff_acis_vs_activated				= _buff_acis_vs_activated;

	//---------------------------------------------------------------------------------
	//puntero a buffer para las estructuras de acción ejecutadas.
	this->buff_execute_acis_vs					= _buff_execute_acis_vs;
	...
	this->buff_inis_vd_sus						= _buff_inis_vd_sus;
	this->buff_acis_vs_sus						= _buff_acis_vs_sus;
	this->buff_pfrlis_sus						= _buff_pfrlis_sus;
	this->buff_indfrlis_vd_sus					= _buff_indfrlis_vd_sus;

	//---------------------------------------------------------------------------------
	//seteo de punteros a buffers para las estructuras creadas.
	this->buff_inis_vd_cre						= _buff_inis_vd_cre;
	this->buff_acis_vs_cre						= _buff_acis_vs_cre;	
	this->buff_pfrlis_cre						= _buff_pfrlis_cre;	
	this->buff_indfrlis_vd_cre					= _buff_indfrlis_vd_cre;										
	this->buff_inprrlis_vd_cre					= _buff_inprrlis_vd_cre;

	//---------------------------------------------------------------------------------
	//seteo de punteros a buffers para las estructuras reconocidas.
	this->buff_inis_vd_re						= _buff_inis_vd_re;
	this->buff_acis_vs_re						= _buff_acis_vs_re;
	this->buff_indfrlis_vd_re					= _buff_indfrlis_vd_re;
	this->buff_inprrlis_vd_re					= _buff_inprrlis_vd_re;

	//---------------------------------------------------------------------------------
	//seteo de punteros a buffers de id de las upci candidatas.
	this->buff_upci_id_inis_vd_can				= _buff_upci_id_inis_vd_can;
	this->buff_upci_id_acis_vs_can				= _buff_upci_id_acis_vs_can;
	this->buff_upci_id_indfrlis_vd_can			= _buff_upci_id_indfrlis_vd_can;
	this->buff_upci_id_inprrlis_vd_can			= _buff_upci_id_inprrlis_vd_can;

	//---------------------------------------------------------------------------------
	//seteo de punteros buffers de estructuras candidatas.
	this->buff_inis_vd_id_can					= _buff_inis_vd_can;
	this->buff_acis_vs_id_can					= _buff_acis_vs_can;
	this->buff_indfrlis_vd_id_can				= _buff_indfrlis_vd_can;
	this->buff_inprrlis_vd_id_can				= _buff_inprrlis_vd_can;
}
...
//-------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------
//#1: método para Clean UPCI_ARG_VDS.
vo  UPCI_ARG_VDS::Clean()
{
	//---------------------------------------------------------------------------------
	//limpieza de argumentos: parámetros estructurales.
	this->inis_vd_amount_allowed				= NULL;								
	this->acis_vs_amount_allowed				= NULL;								
	this->rlis_amount_allowed					= NULL;			

	//---------------------------------------------------------------------------------
    //limpieza de argumentos: dimensiones del registro de entrada.
    this->x_length								= NULL;							
	...
	this->indfrlis_vd_strength_threshold		= NULL;
	...
	this->buff_inis_vd_activated				= NULL;
	this->buff_acis_vs_activated				= NULL;
	//---------------------------------------------------------------------------------
	//limpieza de puntero a buffer para las estructuras de acción ejecutadas.
	this->buff_execute_acis_vs					= NULL;
	...
	this->buff_inis_vd_sus						= NULL;	
	this->buff_acis_vs_sus						= NULL;
	this->buff_pfrlis_sus						= NULL;
	this->buff_indfrlis_vd_sus					= NULL;

	//---------------------------------------------------------------------------------
	//limpieza de punteros a buffers para las estructuras creadas.
	this->buff_inis_vd_cre						= NULL;
	this->buff_acis_vs_cre						= NULL;	
	this->buff_pfrlis_cre						= NULL;	
	this->buff_indfrlis_vd_cre					= NULL;											
	this->buff_inprrlis_vd_cre					= NULL;	

	//---------------------------------------------------------------------------------
	//limpieza de punteros a buffers para las estructuras reconocidas.
	this->buff_inis_vd_re						= NULL;
	this->buff_acis_vs_re						= NULL;
	this->buff_indfrlis_vd_re					= NULL;
	this->buff_inprrlis_vd_re					= NULL;

	//---------------------------------------------------------------------------------
	//limpieza de punteros a buffers de id de las upci candidatas.
	this->buff_upci_id_inis_vd_can				= NULL;
	this->buff_upci_id_acis_vs_can				= NULL;
	this->buff_upci_id_indfrlis_vd_can			= NULL;
	this->buff_upci_id_inprrlis_vd_can			= NULL;

	//---------------------------------------------------------------------------------
	//limpieza de punteros buffers de estructuras candidatas.
	this->buff_inis_vd_id_can					= NULL;
	this->buff_acis_vs_id_can					= NULL;
	this->buff_indfrlis_vd_id_can				= NULL;
	this->buff_inprrlis_vd_id_can				= NULL;							
}
