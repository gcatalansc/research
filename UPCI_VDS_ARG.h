...
namespace UPC
{
	...
	public:		
		...
		in					acis_vs_amount_allowed;											//cantidad de estructuras de acción permitidas.
		...
		dou					indfrlis_vd_strength_threshold;									//umbral de fortaleza de relación INDFRLIS_VD para eliminar relación por N.A.
		...
		BUFF_STR_II			*buff_str_max_eval;												//puntero a buffer para la estructura INIS_VD con máxima evaluación
	...
	public:
		...
		//-----------------------------------------------------------------------------
		//método para limpiar UPCI_ARG_VDS.
		vo  Clean();
	};
}
