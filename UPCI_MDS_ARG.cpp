...
//-------------------------------------------------------------------------------------
//librerias.
#include "UPCI_ARG_MDS.h"

//-------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------
//#1: constructor 1.
UPCI_ARG_MDS::UPCI_ARG_MDS()
{
...
//-------------------------------------------------------------------------------------
//#2: constructor 2.
UPCI_ARG_MDS::UPCI_ARG_MDS(in	_inis_md_amount_allowed,
						   ...
						   in	_timeout_update_al_is)
{
	...
	this->indfrlis_md_strength_threshold	= _indfrlis_md_strength_threshold;						//umbral de fortaleza de relación INDFRLIS_MD para eliminar relación por N.A.
...
vo  UPCI_ARG_MDS::Initialize(in		_inis_md_amount_allowed,
							 in		_acis_vs_amount_allowed,
							 in		_rlis_amount_allowed,
							 in     _x_length,
							 in     _y_length,
...
vo	UPCI_ARG_MDS::SetPtrBuff(in					*_suspended_actions_maximization_flag,
						     ...
						     dededein			*_buff_inprrlis_md_can)
 {
	...
	this->buff_upci_mds							= _buff_upci_mds;
	...
	this->buff_indfrlis_md_sus					= _buff_indfrlis_md_sus;
	...
	this->buff_indfrlis_md_cre					= _buff_indfrlis_md_cre;										
	this->buff_inprrlis_md_cre					= _buff_inprrlis_md_cre;
	...
	this->buff_indfrlis_md_re					= _buff_indfrlis_md_re;
	this->buff_inprrlis_md_re					= _buff_inprrlis_md_re;
	...
	this->buff_upci_id_indfrlis_md_can			= _buff_upci_id_indfrlis_md_can;
	this->buff_upci_id_inprrlis_md_can			= _buff_upci_id_inprrlis_md_can;
	...
	this->buff_indfrlis_md_id_can				= _buff_indfrlis_md_can;
	this->buff_inprrlis_md_id_can				= _buff_inprrlis_md_can;
}
...
//-------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------
//#1: método para Clean UPCI_ARG_MDS.
vo  UPCI_ARG_MDS::Clean()
{
	//---------------------------------------------------------------------------------
	...
	//---------------------------------------------------------------------------------
    //limpíeza de argumentos: dimensiones del registro de entrada.
    this->x_length								= NULL;									
    this->y_length								= NULL;										
	...
	this->indfrlis_md_strength_threshold		= NULL;
	...
	this->buff_indfrlis_md_sus					= NULL;
	...
	this->buff_indfrlis_md_cre					= NULL;											
	this->buff_inprrlis_md_cre					= NULL;	

	//---------------------------------------------------------------------------------
	//limpieza de punteros a buffers para las estructuras reconocidas.
	this->buff_inis_md_re						= NULL;
	this->buff_acis_vs_re						= NULL;
	this->buff_indfrlis_md_re					= NULL;
	this->buff_inprrlis_md_re					= NULL;
	...
	this->buff_upci_id_indfrlis_md_can			= NULL;
	this->buff_upci_id_inprrlis_md_can			= NULL;

	//---------------------------------------------------------------------------------
	//limpieza de punteros buffers de estructuras candidatas.
	this->buff_inis_md_id_can					= NULL;
	this->buff_acis_vs_id_can					= NULL;
	this->buff_indfrlis_md_id_can				= NULL;
	this->buff_inprrlis_md_id_can				= NULL;							
}
