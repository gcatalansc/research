...
vo PFRLIS::Create(in _str1_type, in _str2_type, in _str1_id, in _str2_id, in _upci_type_str1, in _upci_type_str2, in _upci_id_str1, in _upci_id_str2, dou	_rs_srg, dou _al_srg)
{
	//---------------------------------------------------------------------------------
	//inicialización de registros.
...
vo PFRLIS::Set(in _str1_type, in _str2_type, in _str1_id, in _str2_id, in _upci_type_str1, in _upci_type_str2, in _upci_id_str1, in _upci_id_str2, dou _rs_srg, dou _al_srg)
{
	//---------------------------------------------------------------------------------
	//seteo de registros.
	this->STR1_TYPE_RG		= _str1_type;													//tipo de estructura n°1.
